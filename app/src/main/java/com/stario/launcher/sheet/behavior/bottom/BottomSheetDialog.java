...
public class BottomSheetDialog extends SheetDialog {
    private SheetCoordinator container;

    public BottomSheetDialog(ThemedActivity activity, int themeResId) {
    ...
    protected SheetCoordinator getContainer() {
        if (container == null) {
            container = (SheetCoordinator) View.inflate(getContext(), R.layout.bottom_sheet_dialog, null);

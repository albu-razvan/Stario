...
public class SheetDragHelper {
    ...
    private static final int BASE_SETTLE_DURATION = 128; // ms
     ...
     * @return a new ViewDragHelper instance
     */
    public static SheetDragHelper create(@NonNull ViewGroup forParent, float sensitivity,
                                        @NonNull Callback cb) {
        final SheetDragHelper helper = create(forParent, cb);

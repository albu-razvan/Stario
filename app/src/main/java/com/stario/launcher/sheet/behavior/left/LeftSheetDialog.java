...
public class LeftSheetDialog extends SheetDialog {
    private SheetCoordinator container;

    public LeftSheetDialog(ThemedActivity activity, int themeResId) {
    ...
    protected SheetCoordinator getContainer() {
        if (container == null) {
            container = (SheetCoordinator) View.inflate(getContext(), R.layout.left_sheet_dialog, null);
